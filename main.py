...
if __name__ == "__main__":
    ...
    if choice == "n":
        ...
        plt.title("Cumulative Average Victories per Starter", fontsize=20, fontweight='bold')
        plt.xlabel("Number of Battles", fontsize=18)
        plt.ylabel("Average Cumulative Victories", fontsize=18)
